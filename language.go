...
// NormalizeLanguage normalizes a language code to lowercase with hyphen separator.
...
// Returns ErrInvalidLanguage if the base language is not recognized.
